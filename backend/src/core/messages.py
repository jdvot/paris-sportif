...
EXPLANATIONS_TEMPLATES: dict[Language, dict[str, str]] = {
    ...
    "nl": {
        "home_win": (
            "Onze analyse geeft de voorkeur aan {home} voor deze wedstrijd. Het team profiteert van "
            "een sterk thuisvoordeel gecombineerd met een uitstekende huidige vorm. {away} blijft "
