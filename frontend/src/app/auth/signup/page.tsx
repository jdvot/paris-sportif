...
export default function SignUpPage() {
  ...
  if (success) {
    return (
      <div className="min-h-screen flex items-center justify-center px-4 py-12 bg-gray-50 dark:bg-dark-900">
        <div className="w-full max-w-md text-center">
          <div className="bg-white dark:bg-dark-800/80 backdrop-blur-xl border border-gray-300 dark:border-dark-700 rounded-3xl p-10 shadow-2xl">
