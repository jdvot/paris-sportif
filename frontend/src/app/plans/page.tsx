...
export default function PlansPage() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-dark-900 to-dark-800 py-12 px-4">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-12">
          ...
          <div className="bg-dark-800/50 border border-dark-700 rounded-2xl p-8">
            ...
            <p className="text-3xl font-bold text-white mb-6">
              0€ <span className="text-sm text-dark-400 font-normal">/mois</span>
            </p>
            <ul className="space-y-3 mb-8">
              ...
              <li className="flex items-center gap-3 text-dark-400 line-through">
            ...
            <Link
              href="/"
              className="block w-full text-center py-3 px-4 bg-dark-700 text-white rounded-lg hover:bg-dark-600 transition-colors"
            >
              Plan actuel
            </Link>
          </div>
          ...
          <div className="bg-gradient-to-b from-yellow-500/20 to-yellow-600/10 border-2 border-yellow-500/50 rounded-2xl p-8 relative">
            <div className="absolute -top-3 left-1/2 -trandark-x-1/2 bg-yellow-500 text-black text-sm font-semibold px-4 py-1 rounded-full">
              Recommandé
            </div>
            ...
            <p className="text-3xl font-bold text-white mb-6">
              9.99€ <span className="text-sm text-dark-400 font-normal">/mois</span>
            </p>
            <ul className="space-y-3 mb-8">
              <li className="flex items-center gap-3 text-dark-300">
                <Check className="w-5 h-5 text-green-400" />
