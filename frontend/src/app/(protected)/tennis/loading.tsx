    ...
    <div className="space-y-6 sm:space-y-8">
      ...
      <section className="text-center py-6 sm:py-8 px-4">
        <div className="flex items-center justify-center gap-2 mb-2 sm:mb-3">
          ...
          <div className="h-8 sm:h-10 bg-gray-200 dark:bg-slate-700 rounded w-56 animate-pulse" />
        </div>
        <div className="h-4 bg-gray-200 dark:bg-slate-700 rounded w-48 mx-auto animate-pulse" />
      </section>
      ...
      <section className="px-4 sm:px-0">
        <div className="flex items-center justify-between gap-4">
          ...
          <div className="h-9 w-[180px] bg-gray-200 dark:bg-slate-700 rounded-md animate-pulse" />
        </div>
