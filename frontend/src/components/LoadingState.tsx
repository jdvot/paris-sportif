  ...
  if (variant === "minimal") {
    return (
      <div className="flex items-center justify-center gap-3 py-4">
        ...
        <span className="text-dark-400 text-sm animate-pulse">{message}</span>
      </div>
    );
  }
      ...
      <div className="space-y-6 px-4 sm:px-0">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
          {[1, 2, 3, 4].map((idx) => (
            <div
              key={idx}
              className="bg-gradient-to-br from-primary-500/10 to-dark-800/50 border border-primary-500/20 rounded-xl p-4 sm:p-6 animate-pulse"
              style={{ animationDelay: `${idx * 100}ms` }}
            >
              <div className="flex items-center justify-between mb-3">
                <div className="h-3 w-24 bg-dark-700/50 rounded" />
                <div className="w-5 h-5 bg-dark-700/50 rounded" />
              </div>
              <div className="h-8 w-20 bg-dark-700 rounded mb-2" />
              <div className="h-3 w-28 bg-dark-700/30 rounded" />
            </div>
          ))}
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6">
          <div className="lg:col-span-2 bg-dark-800/50 border border-dark-700 rounded-xl p-4 sm:p-6">
            ...
            <div className="h-72 sm:h-80 bg-dark-700/30 rounded-lg animate-pulse" />
          </div>
    ...
    return (
      <div className="bg-dark-800/50 border border-dark-700 rounded-xl overflow-hidden mx-4 sm:mx-0">
        ...
        <div className="flex items-center justify-center gap-3 py-3 border-b border-dark-700 bg-dark-800/30">
          ...
          <span className="text-dark-400 text-xs animate-pulse">{message}</span>
        </div>
          ...
          {[1, 2, 3, 4, 5].map((i) => (
            ...
            >
              <div className="flex items-center gap-3 sm:gap-4 flex-1 min-w-0 w-full sm:w-auto">
                <div className="w-2 h-7 sm:h-8 rounded-full bg-gradient-to-b from-dark-600 to-dark-700 animate-pulse flex-shrink-0" />
                <div className="space-y-2 flex-1">
                  <div className="h-4 w-48 sm:w-64 bg-gradient-to-r from-dark-700 to-dark-600 rounded animate-pulse" />
  ...
  return (
    <div className="grid gap-3 sm:gap-4 px-4 sm:px-0">
      ...
      {Array.from({ length: count }).map((_, i) => (
        <div
          key={i}
          className="bg-dark-800/50 border border-dark-700 rounded-xl overflow-hidden animate-stagger-in"
        ...
        >
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div className="space-y-2">
                  <div className="h-4 w-40 sm:w-56 bg-gradient-to-r from-dark-700 to-dark-600 rounded animate-pulse" />
                  <div className="h-3 w-24 bg-dark-700/50 rounded animate-pulse" />
                </div>
              </div>
          ...
          <div className="px-4 sm:px-6 py-4 space-y-4">
            ...
            <div className="h-10 bg-dark-700/30 border border-dark-600/50 rounded-lg animate-pulse" />
            ...
            <div className="flex gap-2">
              {[1, 2, 3].map((j) => (
                <div key={j} className="h-6 w-24 bg-dark-700 rounded animate-pulse" />
              ))}
            </div>
          </div>
        </div>
